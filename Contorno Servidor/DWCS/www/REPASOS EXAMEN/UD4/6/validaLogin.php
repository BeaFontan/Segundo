...
function fechaConexion($pdo, $fecha, $id): string
{
    try {
        ...
        return "Erro na fecha " . $e->getMessage();
    }
}
...
if (isset($_POST["btnLogin"])) {
    ...
    if (is_string($usuario)) {
        ...
        if (!$passCorrecto) {
            ...
            $actualizarFecha =  fechaConexion($pdo, $fecha, $usuario["id"]);
            ...
            if (str_contains($actualizarFecha, "Erro")) {
                ...
                setcookie("idioma_usuario", $idioma, time() + 100000000);
